...
namespace RevolaAgent.Infrastructure.Persistence.Migrations
{
    ...
    public partial class IdentityTenancy : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Memberships_UserId_Active_TenantId",
                table: "Memberships",
                columns: new[] { "UserId", "Active", "TenantId" });
            ...
            migrationBuilder.Sql("""
                CREATE FUNCTION revola_reject_audit_mutation() RETURNS trigger LANGUAGE plpgsql AS $$
                BEGIN
                    RAISE EXCEPTION 'Audit events are append-only';
                END;
                $$;
                CREATE TRIGGER audit_events_append_only
                BEFORE UPDATE OR DELETE OR TRUNCATE ON "AuditEvents"
        ...
        {
            migrationBuilder.Sql("DROP TRIGGER audit_events_append_only ON \"AuditEvents\"; DROP FUNCTION revola_reject_audit_mutation();");
