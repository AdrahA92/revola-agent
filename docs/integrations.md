...
In Phase 0 sind alle Integrationen geplant. Bis einschließlich Phase 6 wird ausschließlich ein Fake-Adapter verwendet. Eine produktive Plattform wird erst nach API- und Richtlinienprüfung ausgewählt.
